"""
Train FNO + MLP model on call options using VIX OHLC history (vix_history).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO+MLP on calls with VIX history input")
