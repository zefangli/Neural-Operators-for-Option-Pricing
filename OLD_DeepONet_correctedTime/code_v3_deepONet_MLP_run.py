...
def train_model():
    ...
    config = {
        ...
        'colloc_ratio': 0.2,
        'points_per_u': 10,      # Number of coordinate points per branch input
        'num_boundary': 128, 
        'grad_clip': 1.0,
        'M_max': 3.0,
        'tau_max': 5.32,
    ...
    lambdas = {'data': 1.0, 'pde': 1.5, 'arb': 1.5, 'term': 0.5, 'lower': 0.5, 'upper': 0.5}
    ...
    scheduler = ReduceLROnPlateau(optimizer_adam, 'min', factor=0.5, patience=10) #changed patience=better be 2
