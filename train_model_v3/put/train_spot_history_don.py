"""
Train FNO-DeepONet model on put options using SPX OHLCV history (spot_history).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO-DeepONet on puts with spot history input (V3, analytical BS)")
