"""
Train FNO-DeepONet model on call options using implied volatility surface (branch_u).
V3.1: Per-query implicit IV surface via a branch/trunk DeepONet.

Architecture:
  Branch: 2D FNO on IV surface grid (11x17) -> volatility basis vector
...
def get_config():
    ...
    return {
        ...
        "modes2": 8,
        "option_type": "call",
        "results_dir": str(script_dir / "results_vol_surface_don_v5"),
    }
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO-DeepONet on calls with vol surface input (V3, analytical BS)")
    ...
    parser.add_argument("--results-dir", type=str, default=None,
                        help="Override the output directory (default: results_vol_surface_don_v5). "
