"""
Train FNO model on call options using SPX OHLCV history (spot_history).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO on calls with spot history input (V3, analytical BS)")
