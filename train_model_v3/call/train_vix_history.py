"""
Train FNO model on call options using VIX OHLC history (vix_history).
...
def get_config():
    ...
    return {
        ...
        "modes2": 2,
        "option_type": "call",
        # Fresh v5 dir: the old results_vix_history/ dirs were trained on VVIX
        # (mislabeled input) and are quarantined under _vix_is_vvix_LEGACY/ — never
        # write into them again.
        "results_dir": str(script_dir / "results_vix_history_v5"),
    }
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO on calls with vix history input (V3, analytical BS)")
    ...
    parser.add_argument("--h5-path", type=str, default=None,
                        help="Override the input HDF5 (default: deeponet_tensors_call_v5.h5). Must be a "
    ...
    parser.add_argument("--results-dir", type=str, default=None,
                        help="Override the output directory (default: results_vix_history_v5). "
                             "Old results_vix_history/ dirs are VVIX-quarantined; do not reuse them.")
