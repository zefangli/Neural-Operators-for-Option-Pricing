"""
Train FNO-DeepONet model on call options using SPX OHLCV history (spot_history).
V3.1: Per-query implicit IV surface via a branch/trunk DeepONet.

Architecture:
  Branch: 2D FNO on spot history grid (21x5) -> volatility basis vector
...
def get_config():
    ...
    return {
        ...
        "modes2": 2,
        "option_type": "call",
        "results_dir": str(script_dir / "results_spot_history_don_v5"),
    }
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO-DeepONet on calls with spot history input (V3, analytical BS)")
    ...
    parser.add_argument("--results-dir", type=str, default=None,
                        help="Override the output directory (default: results_spot_history_don_v5). "
