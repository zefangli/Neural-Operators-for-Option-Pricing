"""
Train FNO + MLP model on put options using SPX OHLCV history (spot_history).
V2: Two-stage training with pretrained, frozen Network 2.

Architecture:
  Network 1: 2D FNO on spot history grid (21x5) -> sigma_hat (positive scalar)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO+MLP on puts with spot history input (V2)")
