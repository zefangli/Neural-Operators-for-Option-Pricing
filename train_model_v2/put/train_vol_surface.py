"""
Train FNO + MLP model on put options using implied volatility surface (branch_u).
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train FNO+MLP on puts with vol surface input (V2)")
