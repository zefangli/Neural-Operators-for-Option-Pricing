...
Architecture:
  ...
  Network 2: MLP([log_moneyness, T_years, r, q, sigma_hat]) -> log(V/K)
             (pretrained and frozen during stage 1)
...
def train_model(config):
    ...
    # Load pretrained net2 and freeze it
    ...
    model.freeze_net2()
    print("Network 2 frozen (requires_grad = False).")
    ...
    # Optimizer on net1 only (net2 is frozen)
...
def parse_args():
    parser = argparse.ArgumentParser(description="V2: Train FNO+MLP on puts with VIX history input (pretrained, frozen Net2)")
