"""
V2: Two-stage training with pretrained, frozen Network 2 (MLP_Predictor).

Architecture:
  Network 1: 2D FNO on VIX history grid (21x4) -> sigma_hat (positive scalar)
  Network 2: MLP([log_moneyness, T_years, r, q, sigma_hat]) -> log(V/K)  [pretrained + frozen]
...
def parse_args():
    parser = argparse.ArgumentParser(description="V2: Train FNO+MLP on calls with VIX history (pretrained frozen Network 2)")
